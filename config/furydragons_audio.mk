...
ALARM_PATH := vendor/furydragons/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/furydragons/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/furydragons/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/furydragons/prebuilt/common/media/audio/ui
