...
def is_in_manifest(projectpath):
    ...
    # ... and don't forget the furydragons snippet
    try:
        lm = ElementTree.parse(".repo/manifests/snippets/furydragons.xml")
        lm = lm.getroot()
    except:
        lm = ElementTree.Element("manifest")
...
def fetch_dependencies(repo_path, fallback_branch = None):
    ...
    dependencies_paths = [repo_path + '/furydragons.dependencies', repo_path + '/furydragons.dependencies']
